...
If the plan is a custom platform rather than another Moodle, the two load-bearing plugins stop being risks and become part of the spec. The cohort-access rule and the competency calculation get written down, built on purpose, and tested. That's the real argument for [a custom Moodle alternative](/lms-alternatives/moodle): not that Moodle is bad, but that the rules you've been keeping in plugins and memory finally get to live in code you own.
